import{r as e}from"./chunk-PTVI3W5X-Cn8XL4Nk.js";import{M as t,N as n,T as r,n as i}from"./chunk-V7P66DNM-B7R_0UTl.js";import{C as a,E as o,J as s,Q as c,Y as l,b as u,l as d,m as f,o as p,x as m}from"./chunk-Q52JI7PB-VzJ8-Re3.js";import{t as h}from"./chunk-PUIB63ON-Cu6kSMBD.js";import"./chunk-7TFACZ55-hJmyXcBb.js";import{h as g,i as _}from"./chunk-BSZA5ISF-DuWeqZcF.js";import{y as v}from"./chunk-BBDM4ZFP-BSOAnfs4.js";import{t as y}from"./chunk-6ZKBGPIT-CXGCzzCH.js";var b=f.pie,x={sections:new Map,showData:!1,config:b},S=x.sections,C=x.showData,w=structuredClone(b),T={getConfig:e(()=>structuredClone(w),`getConfig`),clear:e(()=>{S=new Map,C=x.showData,p()},`clear`),setDiagramTitle:c,getDiagramTitle:o,setAccTitle:l,getAccTitle:m,setAccDescription:s,getAccDescription:u,addSection:e(({label:e,value:t})=>{if(t<0)throw Error(`"${e}" has invalid value: ${t}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);S.has(e)||(S.set(e,t),r.debug(`added new section: ${e}, with value: ${t}`))},`addSection`),getSections:e(()=>S,`getSections`),setShowData:e(e=>{C=e},`setShowData`),getShowData:e(()=>C,`getShowData`)},E=e((e,t)=>{y(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},`populateDb`),D={parse:e(async e=>{let t=await v(`pie`,e);r.debug(t),E(t,T)},`parse`)},O=e(e=>`
  .pieCircle{
