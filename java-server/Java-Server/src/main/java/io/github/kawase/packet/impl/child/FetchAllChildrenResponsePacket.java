...
@Getter
public class FetchAllChildrenResponsePacket extends Packet {
    ...
    public FetchAllChildrenResponsePacket(final List<ChildDto> children) {
        super(42);
        this.children = children;
    }

    public FetchAllChildrenResponsePacket() {
        super(42);
    }
