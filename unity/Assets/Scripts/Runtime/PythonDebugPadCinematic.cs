...
public class PythonDebugPadCinematic : MonoBehaviour
{
    ...
    private string BuildAiChatContext()
    {
        if (mode == ChallengeMode.Medium)
        {
            return "python_medium_hint";
        }

        return "python_hard_hint";
    }
    ...
    private InputField EnsureCodeInput(Transform parent)
    {
        ...
        placeholder.text = "Scrie aici codul Python...";
...
public static class PythonDebugPadCinematicBootstrap
{
    [RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.AfterSceneLoad)]
    private static void AttachIfNeeded()
    {
        Attach("MediumDebugPadPy", 0);
    }
    ...
    private static void Attach(string padName, int mode)
    {
        ...
        PythonDebugPadCinematic component = pad.GetComponent<PythonDebugPadCinematic>();
        if (component == null)
        {
            component = pad.AddComponent<PythonDebugPadCinematic>();
        }
